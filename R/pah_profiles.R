...
#' @return Returns a long dataframe where observations are repeated for each sample/compound combination. Adds to the input
#' dataframe all columns in `source_profiles`, as well as the chi-squared difference between source and sample.
#' @import dplyr
